          ...
          children: [
            ...
            RichText(
              ...
              text: TextSpan(
                ...
                children: [
                  const TextSpan(text: 'Bạn có chắc chắn muốn đặt lại mật khẩu cho tài khoản '),
                  TextSpan(text: user['name'], style: const TextStyle(fontWeight: FontWeight.bold, color: AppTheme.text)),
                  const TextSpan(text: '? Một đường dẫn thiết lập mật khẩu mới sẽ được gửi về email của họ.'),
                ],
              ),
            ),
