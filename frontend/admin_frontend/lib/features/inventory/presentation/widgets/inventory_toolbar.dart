          ...
          const Expanded(
            ...
            child: TextField(
              decoration: InputDecoration(
                hintText: 'Tìm kiếm theo mã SKU, tên sản phẩm...',
          ...
          Container(
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                ...
                items: const [
                  DropdownMenuItem(value: 'all', child: Text('Tất cả kho')),
                  DropdownMenuItem(value: 'hn01', child: Text('Kho Hà Nội 01')),
                  DropdownMenuItem(value: 'hcm02', child: Text('Kho HCM 02')),
                ],
                onChanged: (value) {},
              ),
            ),
